          ...
          {featuredServices.length > 0 ? (
            <div className="mt-14 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
              <Reveal className="card-shell p-10">
                ...
                <Link href={`/services/${featuredServices[0].slug}`} className="button-primary mt-8">
                  Learn More
                </Link>
              </Reveal>
              ...
              <div className="grid gap-6">
                {secondaryServices.map((service, index) => (
                  <Reveal key={service.slug} delay={index * 90} className="card-shell p-8">
                    ...
                    <Link href={`/services/${service.slug}`} className="button-ghost mt-6">
                      Explore
                    </Link>
                  </Reveal>
                ))}
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2">
              {upcomingEvents.map((event, index) => (
                ...
                >
                  ...
                  <h3 className="display-title mt-4 text-3xl">{event.name}</h3>
