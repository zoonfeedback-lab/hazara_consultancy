      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <div>
            <input
              ...
              className="hidden"
              onChange={() => {
                showToast("Storage integration coming soon", "info");
        ...
        {rows.length === 0 ? (
          <div className="admin-empty-state">
            ...
            <p className="text-sm text-[#4B5563]">Storage-backed uploads will appear here once media integration is live.</p>
          </div>
        ) : (
              ...
              <div key={item.id} className="admin-card overflow-hidden p-4">
                <div className="h-[200px] overflow-hidden rounded-[12px] bg-[#F0EDE6]">
                  {item.publicUrl ? (
                    ...
                    <div className="flex h-full items-center justify-center text-sm text-[#6B7280]">No preview</div>
                  )}
                </div>
